...
このスキルは `~/.agents/skills/` と `~/.claude/commands/` の内容を GitHub リポジトリ `mextexco/skills` と同期する。
...
cp -r ~/.claude/commands/. "$REPO_DIR/commands/"
